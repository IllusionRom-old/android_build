...
- tapas:   tapas [<App1> <App2> ...] [arm|x86|mips|armv5] [eng|userdebug|user|illusion]
...
VARIANT_CHOICES=(user userdebug eng illusion)
...
function tapas()
{
    ...
    local variant=$(echo -n $(echo $* | xargs -n 1 echo | \grep -E '^(user|userdebug|eng|illusion)$'))
